...
public class HtmlPublisherTest extends HudsonTestCase {
    ...
    public void testConfigRoundtrip() {
        ...
        def l = [new HtmlPublisherTarget("a", "b", "c", "d", true, true, false), new HtmlPublisherTarget("", "", "", "", false, false, false)]
        ...
        (0..1).each {
            assertEqualBeans(l[it],r.reportTargets[it],"reportName,reportDir,reportFiles,failureRegex,keepAll,alwaysLinkToLastBuild,allowMissing");
        }
    }
